...
namespace nd {
  namespace functional {
    ...
    public:
      ...
      void instantiate(char *static_data, char *DYND_UNUSED(data), dynd::nd::kernel_builder *ckb,
                       ...
                       const std::map<std::string, dynd::ndt::type> &tp_vars)
      {
        ...
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), nullptr, ckb, dst_tp, dst_arrmeta,
                                             1, &child_src_tp, nullptr, dynd::kernel_request_single, 0, nullptr,
                                             tp_vars);
      }
    };
