...
namespace nd {
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      assign_na.get()->instantiate(assign_na.get()->static_data(), NULL, ckb, dst_tp, dst_arrmeta, nsrc, NULL, NULL,
      ...
      dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), NULL, ckb,
                                           dst_tp.extended<dynd::ndt::option_type>()->get_value_type(), dst_arrmeta,
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      for (intptr_t i = 0; i < field_count; ++i) {
        ...
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), NULL, ckb, field_types[i],
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      if (dst_tp.get_as_strided(dst_arrmeta, &dim_size, &stride, &el_tp, &el_arrmeta)) {
        ...
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), NULL, ckb, el_tp, el_arrmeta, nsrc,
        ...
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), NULL, ckb, el_tp, el_arrmeta, 1,
