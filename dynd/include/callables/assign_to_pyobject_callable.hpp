...
namespace nd {
  ...
  public:
    ...
    void instantiate(char *DYND_UNUSED(static_data), char *DYND_UNUSED(data), dynd::nd::kernel_builder *ckb,
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      is_na.get()->instantiate(is_na.get()->static_data(), NULL, ckb, dynd::ndt::make_type<dynd::bool1>(), NULL, nsrc,
                               src_tp, src_arrmeta, dynd::kernel_request_single, 0, NULL, tp_vars);
      ...
      dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), NULL, ckb, dst_tp, dst_arrmeta, nsrc,
                                           &src_value_tp, src_arrmeta, dynd::kernel_request_single, 0, NULL, tp_vars);
    }
  };
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      for (intptr_t i = 0; i < field_count; ++i) {
        ...
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), data, ckb, dst_tp, dst_arrmeta,
                                             nsrc, &field_types[i], &field_arrmeta, dynd::kernel_request_single, nkwd,
                                             kwds, tp_vars);
        ckb_offset = ckb->size();
      }
    }
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      for (intptr_t i = 0; i < field_count; ++i) {
        ...
        self_ck->m_copy_el_offsets[i] = ckb_offset - root_ckb_offset;
        const char *field_arrmeta = src_arrmeta[0] + arrmeta_offsets[i];
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), NULL, ckb, dst_tp, dst_arrmeta,
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      if (src_tp[0].get_as_strided(src_arrmeta[0], &dim_size, &stride, &el_tp, &el_arrmeta)) {
        ...
        ckb_offset = ckb->size();
        dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), data, ckb, dst_tp, dst_arrmeta,
                                             nsrc, &el_tp, &el_arrmeta, dynd::kernel_request_strided, nkwd, kwds,
                                             tp_vars);
        return;
      }
  ...
  public:
                     ...
                     const dynd::nd::array *kwds, const std::map<std::string, dynd::ndt::type> &tp_vars)
    {
      ...
      dynd::nd::assign::get()->instantiate(dynd::nd::assign::get()->static_data(), data, ckb, dst_tp, dst_arrmeta, nsrc,
