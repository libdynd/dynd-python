                                      ...
                                      const ndt::type &dt)
{
  ...
  set_single_parameter(
      ...
      params.get()->data + fsdt->get_data_offsets(params.metadata())[0], dt);
                                      ...
                                      const dynd::nd::array &n)
{
  ...
  set_single_parameter(
      funcname, fsdt->get_field_name(0), fsdt->get_field_type(0),
      params.metadata() + fsdt->get_arrmeta_offset(0),
      params.get()->data + fsdt->get_data_offsets(params.metadata())[0], n);
                                      ...
                                      PyObject *args, PyObject *kwargs)
{
  ...
  set_single_parameter(
      ...
      params.metadata() + fsdt->get_arrmeta_offset(0),
      params.get()->data + fsdt->get_data_offsets(params.metadata())[0], ncw.n);
