...
class TestArrayGetItem(unittest.TestCase):
    ...
    def test_strided_dim(self):
        ...
        a[...] = nd.range(100)
        self.assertEqual(a.dtype, ndt.type('A, int32'))
        self.assertEqual(a[...].dtype, ndt.type('A, int32'))
        self.assertEqual(a[0].dtype, ndt.int32)
        self.assertEqual(a[0:1].dtype, ndt.type('A, int32'))
    ...
    def test_fixed_dim(self):
        ...
        a[...] = nd.range(100)
        self.assertEqual(a.dtype, ndt.type('100, int32'))
        self.assertEqual(a[...].dtype, ndt.type('100, int32'))
        self.assertEqual(a[0].dtype, ndt.int32)
        self.assertEqual(a[0:1].dtype, ndt.type('A, int32'))
        self.assertEqual(nd.as_py(a[0]), 0)
    ...
    def test_var_dim(self):
        ...
        self.assertEqual(a[...].dtype, ndt.type('var, int32'))
        self.assertEqual(a[:].dtype, ndt.type('M, int32'))
        self.assertEqual(a[0].dtype, ndt.int32)
        self.assertEqual(a[0:1].dtype, ndt.type('A, int32'))
        self.assertEqual(nd.as_py(a[0]), 0)
        self.assertEqual(nd.as_py(a[99]), 99)
    ...
    def test_struct(self):
        ...
        self.assertEqual(a.dtype, ndt.type('{x:int32; y:string; z:float32}'))
        self.assertEqual(a[...].dtype, ndt.type('{x:int32; y:string; z:float32}'))
        self.assertEqual(a[0].dtype, ndt.int32)
        ...
        self.assertEqual(a[1:].dtype, ndt.make_struct_type([ndt.string, ndt.float32], ['y', 'z']))
        self.assertEqual(a[::-2].dtype, ndt.make_struct_type([ndt.float32, ndt.int32], ['z', 'x']))
