...
const dynd::arrfunc_old_type_data *pyarg_arrfunc_ro(PyObject *af, const char *paramname);
dynd::arrfunc_old_type_data *pyarg_arrfunc_rw(PyObject *af, const char *paramname);
